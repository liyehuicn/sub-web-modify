...
export default {
  data() {
    return {
      ...
      options: {
        ...
        customBackend: {
          "本作者提供CF防泄漏": "https://sub.liyehui.workers.dev/",
  ...
  methods: {
    ...
    tanchuang() {
      this.$alert(`<div style="text-align:center;font-size:15px"><strong><span style="font-size:20px;color:red">若作者后端地址被墙请更换：http://jp.khanwebhost.com:11720</br>`, '信息面板', {
